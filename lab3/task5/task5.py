...
from PyQt5.QtWidgets import (QWidget, QLabel, QLineEdit, QGridLayout, QApplication, QPushButton, QCheckBox, QSpinBox, QRadioButton)
...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.radio2 = QRadioButton('Лексикографически')
        # ---------------Position-----------------------------
        grid = QGridLayout()
        grid.setSpacing(10)
    ...
    def buttonClicked(self):
        ...
        if (self.checkbox4.checkState() == 2) and (self.radio2.isChecked):  # Lex
            ...
            self.lineEditResult.setText(self.output_)
        # ----------Output--------------------------
        if ((self.checkbox1.checkState() == 0) and (self.checkbox2.checkState() == 0) and (
